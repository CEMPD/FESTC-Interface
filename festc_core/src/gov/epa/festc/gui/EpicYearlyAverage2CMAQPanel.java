...
public class EpicYearlyAverage2CMAQPanel extends UtilFieldsPanel implements PlotEventListener {
	...
	private JPanel getNorthPanel() {
		...
		JLabel title = new JLabel(Constants.EPIC_YEAR, // Yearly Average for CMAQ", 
	...
	protected String writeRunScriptScript(
		...
		if (spinup)
			sb.append("setenv OUTPUT_NETCDF_FILE_TOTAL " +
					"$SCEN_DIR/output4CMAQ/spinup/toCMAQ/epic2cmaq_year_total.nc" + ls + ls);
		else
			sb.append("setenv OUTPUT_NETCDF_FILE_TOTAL " +
					"$SCEN_DIR/output4CMAQ/app/toCMAQ/epic2cmaq_year_total.nc" + ls + ls);
