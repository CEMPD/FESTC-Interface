...
//	private JButton outDirBrowser;
	...
	public Epic2CMAQPanel(FestcApplication application) {
		app = application;
	...
	protected String writeScript() throws Exception {
		...
		//sb.append("#" + ls + "# Output files: three output files for soil, EPIC daily output, and fertilizer application data" + ls + "#" + ls);
		//sb.append("setenv SOIL_OUTPUT_NETCDF_FILE          \"" + outDir.getText().trim() + "/" + filesPrefix.getText().trim() + "_soil.nc\"" + ls);
		//sb.append("setenv DAILY_OUTPUT_NETCDF_FILE         \"" + outDir.getText().trim() + "/" + filesPrefix.getText().trim() + "_time\"" + ls + ls);
		//sb.append("setenv FERTILIZER_OUTPUT_NETCDF_FILE    \"" + outDir.getText().trim() + "/" + filesPrefix.getText().trim() + "_fert.nc\"" + ls + ls);
		sb.append("#" + ls + 
